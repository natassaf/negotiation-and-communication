...
global {
	...
	init {
		ItemTypes <- ["clothes", "patches", "posters"];
...
{	bool isHungry;
	...
	int wallet;
////////changed here for interested item
...
////////changed here for interested item
		...
		interestedFor<-"clothes"; // remove this
////////// up until here				
...
//////////changed here for round time out
	...
	reflex change_round{
		if ((length(acceptedProposals)+numRejected)= length(participatingGuests)){
